...
let emp1 = new Designer("Bruce ", "Willis", 1700, 11, 0.8);
let emp2 = new Designer("Diana ", "Hiruk", 1700, 11, 0.8);
let emp3 = new Developer("Illia ", "Kravchuk", 1700, 11);
let emp4 = new Developer("Daria ", "Hope", 1700, 11);
let emp5 = new Developer("Emma ", "Watson", 1700, 11);
let emp6 = new Designer("Damon ", "Salvatore", 1700, 11, 0.8);
let emp7 = new Designer("Elena ", "Gilbert", 1700, 11, 0.8);
let emp8 = new Developer("Sonya ", "Ilchuk", 1700, 11);
let emp9 = new Developer("Agata ", "Kristi", 2000, 5);
let emp10 = new Developer("Bonnie ", "Bennet", 2000, 6);
let emp11 = new Developer("Hope ", "Mikaelson", 2000, 6);
let emp12 = new Manager("Niklaus ", "Mikaelson", 4000, 8, [emp11, emp10, emp9, emp8, emp7, emp6, emp5, emp4, emp3, emp2, emp1]);
